...
float3 clipToNDC(float4 clip){
    ...
    return (float3(clip_to_screen.x/clip_to_screen.w, clip_to_screen.y/clip_to_screen.w, clip_to_screen.w));
}
  ...
  void process(int2 pos) {
    ...
    */
    ...
    if (_maxSteps <= 1){
        ...
        // Render the points along the 2d path
    ...
    renderPoint(xy, green, size, coc, 1.0, ndc.z);
    renderPoint(xy_prev, red, size_prev, coc_prev, 1.0, ndc_prev.z);
    renderPoint(xy_next, blue, size_next, coc_next, 1.0, ndc_next.z);
    }
